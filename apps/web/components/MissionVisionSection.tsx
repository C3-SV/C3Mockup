...
import { updateNote } from "@/lib/content";
      ...
      >
        ...
        <div className="container-shell relative z-10 space-y-8">
          <div className="max-w-4xl space-y-4">
            <SectionBadge label="Próximas iniciativas" variant="neutral" />
      ...
      >
        ...
        <div className="container-shell relative z-10 space-y-7">
          <div className="max-w-4xl space-y-3">
            <p className="text-xs font-semibold uppercase tracking-[0.22em] text-white/58">Métricas</p>
            <h3 className="text-3xl font-bold leading-tight md:text-4xl">
              Datos que respaldan el avance de C3
            </h3>
            <p className="text-sm uppercase tracking-[0.14em] text-white/70">{updateNote}</p>
          </div>
