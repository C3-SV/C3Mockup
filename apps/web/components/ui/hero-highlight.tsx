...
export const Highlight = ({
  ...
  return (
    <motion.span
      ...
      className={cn(
        "relative inline-block rounded-[0.7rem] bg-[linear-gradient(180deg,transparent_58%,rgba(79,91,169,0.18)_58%,rgba(79,91,169,0.24)_82%,transparent_82%)] px-1.5 pb-0.5 text-white",
        className,
      )}
    >
      {children}
